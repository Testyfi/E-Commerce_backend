...
func main() {
	...
	r.Use(cors.Handler(cors.Options{
		AllowedOrigins:   []string{os.Getenv("STUDENT_FRONTEND_URL"), os.Getenv("ADMIN_FRONTEND_URL"), "http://localhost:4200", "http://localhost:4201", "https://testtify-7ug6.onrender.com"},
